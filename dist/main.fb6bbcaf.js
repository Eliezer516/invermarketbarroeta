...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/holder.min.js":[function(require,module,exports) {
var define;
  ...
  if (e.document) {
    ...
    t.querySelectorAll || (t.querySelectorAll = function (n) {
      ...
      for (t.documentElement.firstChild.appendChild(i), t._qsa = [], i.styleSheet.cssText = n + "{x-qsa:expression(document._qsa && document._qsa.push(this))}", e.scrollBy(0, 0), i.parentNode.removeChild(i); t._qsa.length;) {
        r = t._qsa.shift(), r.style.removeAttribute("x-qsa"), a.push(r);
      }
      ...
      e.atob = e.atob || function (e) {
        ...
        for (; r < e.length;) {
          n = t.indexOf(e.charAt(r)), a = a << 6 | n, o += 6, 24 === o && (i.push(String.fromCharCode(a >> 16 & 255)), i.push(String.fromCharCode(a >> 8 & 255)), i.push(String.fromCharCode(255 & a)), o = 0, a = 0), r += 1;
        }
        ...
        for (; h < e.length;) {
          n = e.charCodeAt(h++), r = e.charCodeAt(h++), i = e.charCodeAt(h++), a = n >> 2, o = (3 & n) << 4 | r >> 4, s = (15 & r) << 2 | i >> 6, l = 63 & i, h === e.length + 2 ? (s = 64, l = 64) : h === e.length + 1 && (l = 64), u.push(t.charAt(a), t.charAt(o), t.charAt(s), t.charAt(l));
        }
  ...
  return function (e) {
    ...
    (function (t) {
      ...
      for (var M in O.flags) {
        O.flags.hasOwnProperty(M) && (O.flags[M].match = function (e) {
    ...
    function n(e) {
      ...
      var o = e.document,
          ...
          x = h,
          S = [];
      if (o[c] === d) i(t);else if (w) o[g](m, n, h), e[g](l, n, h);else {
        o[f](v, n), e[f](u, n);
    ...
    t.parse = function (e) {
      ...
      for (var t = {}, n = e.split("&"), r = 0; r < n.length; r++) {
        var o,
            ...
            d = n[r].split("="),
            c = i(d[0]);
        if (o = s.exec(c)) t[o[1]] = t[o[1]] || [], t[o[1]][o[2]] = i(d[1]);else if (o = l.test(c)) {
      ...
      for (var n in e) {
        var i = e[n];
        if ("array" != o(i)) t.push(r(n) + "=" + r(e[n]));else for (var a = 0; a < i.length; ++a) {
          t.push(r(n + "[" + a + "]") + "=" + r(i[a]));
        }
      }
    ...
    e.exports = function (e) {
      ...
      return null === e ? "null" : void 0 === e ? "undefined" : e !== e ? "nan" : e && 1 === e.nodeType ? "element" : (e = e.valueOf ? e.valueOf() : Object.prototype.valueOf.apply(e), _typeof(e));
    };
  }, function (e, t) {
    var n = function n(e) {
      function t(e, t) {
    ...
    (function (e) {
      ...
      t.initSVG = function (e, t, n) {
        ...
        for (var h = 0; h < e.childNodes.length; h++) {
          e.childNodes[h].nodeType === a && e.removeChild(e.childNodes[h]);
        }
    ...
    e.exports = function r(e, t, n) {
      ...
      function a(e, t) {
        return null !== t && t !== !1 && void 0 !== t ? "string" != typeof t && "object" != _typeof(t) ? String(t) : t : void 0;
      }
      ...
      for (; c < e.length; c++) {
        ...
        if (void 0 !== e[c] && e[c] !== !0) if ("string" == typeof e[c]) f && (e[c] = s(e[c])), e[0].children.push(e[c]);else if ("number" == typeof e[c]) e[0].children.push(e[c]);else if (Array.isArray(e[c])) {
          ...
          if ("object" != _typeof(e[c])) throw new TypeError('"' + e[c] + '" is not allowed as a value.');

          for (h in e[c]) {
            e[c].hasOwnProperty(h) && null !== e[c][h] && e[c][h] !== !1 && (e[0].attr[h] = "style" === h && "object" == _typeof(e[c][h]) ? JSON.stringify(e[c][h], a).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'") : e[c][h]);
          }
        }
      }
      ...
      if (e[0] !== !1) {
        ...
        for (d in e[0].attr) {
          e[0].attr.hasOwnProperty(d) && (l += " " + d + '="' + o(e[0].attr[d]) + '"');
        }
...
window.addEventListener('scroll', function () {
  var navigation_menu = document.querySelector('nav');
...
},{"./holder.min.js":"js/holder.min.js","./navbar.js":"js/navbar.js","swiper/bundle":"../node_modules/swiper/swiper-bundle.esm.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "15172" + '/');
